...
public class CountingSort {
    ...
    public static int[] countingSort(int[] arr)
    {
        ...
        //The second step is to get define the count array
        ...
        //The fourth step is to count the cumulative sum in the array
        for(int i=1; i<count.length;i++)
        {
            count[i] += count[i-1];
        }

        //The fifth step is to sort the array according to the index and count
