package july02.Sorting;

public class QuickSort {
    public static void main(String[] args)
    {
        //This is also a divide and conquer algorithm for sorting, and it also uses recursion
        //In this algorithm we will sort around the pivot element
